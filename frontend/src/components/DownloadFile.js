...
function DownloadFile() {
    ...
    const handleDownload = async () => {
        ...
        try {
            if(quality === "mp3"){
                const response = await axios.post("http://localhost:8081/api/audio/download", null, {
                    params: { url, format},
                ...
                const response = await axios.post("http://localhost:8081/api/video/download", null, {
